...
const ROMANCE_ARCS = {
  ...
  chloe: [
    ...
    { id: "chloe_trust", type: "trust event", minRelationship: 70, title: "Flooded Studio", prompt: "After a flood damages her instruments, Chloe lets you into the ruined studio.", emotionalBeat: "Letting you witness grief.", choices: [{ text: "Help restore one item slowly with her.", relationshipImpact: 9, chemistryImpact: 10, unlocksMemory: "chloe_restoration_day" }, { text: "Ask what role she wants you to play: helper, listener, or planner.", relationshipImpact: 7, chemistryImpact: 8, unlocksMemory: "chloe_role_request" }, { text: "Tell her to replace everything quickly.", checkStat: "money", threshold: 35, onSuccess: { relationshipImpact: 3, chemistryImpact: 2 }, onFail: { relationshipImpact: -2, chemistryImpact: -2 } }] },
