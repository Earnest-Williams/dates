...
const ROMANCE_ARCS = {
  ...
  brad: [
    { id: "brad_intro", type: "introduction", minRelationship: 0, title: "Post-Workout Truth", prompt: "Brad wipes sweat from his brow, his confidence masking a sudden need for approval. He asks what discipline really means to you when no one is watching.", emotionalBeat: "Confidence masking insecurity and liking explicit praise.", choices: [{ text: "Tell him that true consistency beats flashy intensity.", relationshipImpact: 8, chemistryImpact: 7, unlocksMemory: "brad_respects_consistency" }, { text: "Give him a playful pep-talk challenge.", relationshipImpact: 7, chemistryImpact: 8, unlocksMemory: "brad_likes_motivation_talk" }, { text: "Flex for him and boast about your own PRs.", checkStat: "fitness", threshold: 35, onSuccess: { relationshipImpact: 6, chemistryImpact: 5, unlocksMemory: "brad_impressed_by_flex" }, onFail: { relationshipImpact: -1, chemistryImpact: -2, futureCallback: "brad_awkward_flex" } }] },
    { id: "brad_early", type: "early connection", minRelationship: 18, title: "Meal Prep Night", prompt: "Brad's sponsor requested a live cooking stream. Underneath the bravado, the pressure is getting to him, and he needs someone he trusts to anchor the kitchen.", emotionalBeat: "Bravado under pressure.", choices: [{ text: "Cook together off-camera first to calm his nerves.", relationshipImpact: 7, chemistryImpact: 6, unlocksMemory: "brad_trusts_player_prep" }, { text: "Let him lead while you follow his routine exactly.", relationshipImpact: 6, chemistryImpact: 7, futureCallback: "brad_controlled_kitchen" }, { text: "Push him to wing it live and just be charismatic.", relationshipImpact: -2, chemistryImpact: 1, futureCallback: "brad_stream_disaster" }] },
    { id: "brad_reveal", type: "personal reveal", minRelationship: 35, title: "Old Injury Scare", prompt: "Brad rubs his injured shoulder, finally dropping the invincible act. He admits he's terrified of becoming irrelevant if his body fails him.", emotionalBeat: "Vulnerability beneath bravado.", choices: [{ text: "Tell him his worth is not tied to his PR numbers.", relationshipImpact: 10, chemistryImpact: 9, unlocksMemory: "brad_identity_beyond_fitness" }, { text: "Let me spot you through recovery drills at your pace.", relationshipImpact: 7, chemistryImpact: 8, unlocksMemory: "brad_recovery_drills" }, { text: "Tell him to train harder and silence the doubters.", checkStat: "confidence", threshold: 40, onSuccess: { relationshipImpact: 4, chemistryImpact: 4, unlocksMemory: "brad_pushed_through" }, onFail: { relationshipImpact: -3, chemistryImpact: -2, futureCallback: "brad_injury_worsened" } }] },
    { id: "brad_conflict", type: "conflict", minRelationship: 52, title: "Skipped Session", prompt: "You miss a planned gym meet and Brad immediately shuts down. His fear of not being prioritized flares up into a sharp, sudden argument.", emotionalBeat: "Fear of not being prioritized.", choices: [{ text: "Defend yourself aggressively against his accusations.", relationshipImpact: -6, chemistryImpact: -5, futureCallback: "brad_aggression_memory" }, { text: "Apologize and gently ask what your absence triggered for him.", relationshipImpact: 7, chemistryImpact: 8, unlocksMemory: "brad_opens_about_abandonment" }, { text: "Offer to rebuild trust with a realistic shared routine.", relationshipImpact: 5, chemistryImpact: 6, futureCallback: "brad_repair_schedule" }] },
    { id: "brad_trust", type: "trust event", minRelationship: 70, title: "Rehab Day", sceneTags: ['vulnerability', 'secrecy', 'emotional_hunger'], prompt: "During shoulder rehab, the frustration breaks him. He slumps against the wall, hiding his face, the physical exhaustion blending into deep emotional need.", emotionalBeat: "Shame around weakness, craving physical comfort.", choices: [{ text: "Kneel beside him, pulling his good arm around you to hold him steady.", relationshipImpact: 9, chemistryImpact: 9, tone: { heat: 5, implication: 6, emotionalRisk: 9, publicRisk: 0 } }, { text: "Coach him firmly, replacing his shame with demanding, unyielding focus.", relationshipImpact: 7, chemistryImpact: 10, tone: { heat: 7, implication: 8, emotionalRisk: 7, publicRisk: 0 }, unlocksMemory: "brad_firm_coaching_dynamic" }, { text: "Try to distract him with jokes.", checkStat: "charisma", threshold: 30, onSuccess: { relationshipImpact: 4, chemistryImpact: 5 }, onFail: { relationshipImpact: -1, chemistryImpact: 0 } }] },
    { id: "brad_commitment", type: "commitment event", minRelationship: 90, title: "Off-Season Decision", sceneTags: ['late_night', 'vulnerability', 'longing', 'temptation'], prompt: "Brad can take a major contract that relocates him. He pins you against the counter, voice rough, asking if you're willing to wait.", emotionalBeat: "Desperate need disguised as a question.", choices: [{ text: "Tell him distance only builds the tension until he gets back.", relationshipImpact: 13, chemistryImpact: 14, tone: { heat: 8, implication: 9, emotionalRisk: 8, publicRisk: 0 }, unlocksMemory: "brad_committed_routine" }, { text: "Grab his shirt and promise him exclusive late-night video calls.", relationshipImpact: 10, chemistryImpact: 15, tone: { heat: 9, implication: 10, emotionalRisk: 7, publicRisk: 0 }, futureCallback: "brad_distance_training_arc" }, { text: "Keep it casual and undefined.", relationshipImpact: 2, chemistryImpact: 1, futureCallback: "brad_distance_loop" }] }
  ],
  sophia: [
  ...
  marcus: [
    { id: "marcus_intro", type: "introduction", minRelationship: 0, title: "Calendar Tetris", prompt: "Marcus checks his watch twice before offering a strict ten-minute coffee between investor calls. The control is a survival mechanism, but he relaxes slightly when you lead the conversation.", emotionalBeat: "Control as survival; he relaxes when someone can take the lead.", choices: [{ text: "Use the ten minutes fully, zero posturing.", relationshipImpact: 8, chemistryImpact: 7, unlocksMemory: "marcus_respects_directness" }, { text: "Take charge and set the agenda for him.", relationshipImpact: 7, chemistryImpact: 8, unlocksMemory: "marcus_relieved_by_structure" }, { text: "Pitch yourself aggressively.", checkStat: "corporate", threshold: 45, onSuccess: { relationshipImpact: 6, chemistryImpact: 4, unlocksMemory: "marcus_impressed_by_pitch" }, onFail: { relationshipImpact: -2, chemistryImpact: -2, futureCallback: "marcus_wasted_time" } }] },
    { id: "marcus_early", type: "early connection", minRelationship: 18, title: "Midnight Spreadsheet", prompt: "You find Marcus still working at 2AM, running on espresso and sheer willpower. His exhaustion is heavily disguised as drive, but his hands are shaking.", emotionalBeat: "Exhaustion disguised as drive.", choices: [{ text: "Bring food and sit quietly with him without demanding his attention.", relationshipImpact: 7, chemistryImpact: 8, unlocksMemory: "marcus_allows_care" }, { text: "Tell him to hand over the laptop for twenty minutes of forced rest.", relationshipImpact: 6, chemistryImpact: 7, futureCallback: "marcus_structured_shutdown" }, { text: "Tell him to push through and finish.", relationshipImpact: -1, chemistryImpact: 1, futureCallback: "marcus_burnt_out" }] },
    { id: "marcus_reveal", type: "personal reveal", minRelationship: 35, title: "The Panic Draft", prompt: "Marcus drops his pen, finally admitting he cannot remember his last day off. The admission reveals a deep-seated fear of losing control if he ever stops moving.", emotionalBeat: "Fear of losing control.", choices: [{ text: "Remind him he is allowed to be human, not just useful.", relationshipImpact: 10, chemistryImpact: 9, unlocksMemory: "marcus_seen_when_tired" }, { text: "Build him a clear stop-time ritual for each night.", relationshipImpact: 7, chemistryImpact: 7, unlocksMemory: "marcus_night_ritual" }, { text: "Tell him to optimize his schedule harder.", checkStat: "finance", threshold: 40, onSuccess: { relationshipImpact: 4, chemistryImpact: 3, unlocksMemory: "marcus_schedule_optimized" }, onFail: { relationshipImpact: -3, chemistryImpact: -2, futureCallback: "marcus_optimization_failed" } }] },
    { id: "marcus_conflict", type: "conflict", minRelationship: 52, title: "Do Not Disturb", prompt: "During a board crisis, he ruthlessly silences your messages. His work reflex completely overrides intimacy, leaving you feeling shut out.", emotionalBeat: "Work reflex overriding intimacy.", choices: [{ text: "Accuse him of choosing work over you.", relationshipImpact: -6, chemistryImpact: -4, futureCallback: "marcus_accusation_fight" }, { text: "Name your hurt and ask for a specific time to repair.", relationshipImpact: 7, chemistryImpact: 8, futureCallback: "marcus_repair_conversation" }, { text: "Set a communication protocol for crisis days.", relationshipImpact: 5, chemistryImpact: 6, unlocksMemory: "marcus_crisis_protocol" }] },
    { id: "marcus_trust", type: "trust event", minRelationship: 70, title: "First Real Day Off", sceneTags: ['vulnerability', 'secrecy', 'emotional_hunger'], prompt: "He hands you his phone, his rigid posture finally snapping as he slumps against you on the sofa, desperate to let someone else take control.", emotionalBeat: "Emotional availability practice, surrendering control.", choices: [{ text: "Take the phone and pull him down until his head rests on your chest.", relationshipImpact: 9, chemistryImpact: 10, tone: { heat: 6, implication: 7, emotionalRisk: 8, publicRisk: 0 }, unlocksMemory: "marcus_phone_off" }, { text: "Set hard boundaries: no work, only you, all day.", relationshipImpact: 8, chemistryImpact: 11, tone: { heat: 8, implication: 8, emotionalRisk: 7, publicRisk: 0 }, unlocksMemory: "marcus_structured_offline_day" }, { text: "Turn it into networking anyway.", checkStat: "corporate", threshold: 60, onSuccess: { relationshipImpact: 3, chemistryImpact: 2 }, onFail: { relationshipImpact: -2, chemistryImpact: -2 } }] },
    { id: "marcus_commitment", type: "commitment event", minRelationship: 90, title: "Term Sheet and Terms of Us", sceneTags: ['late_night', 'vulnerability', 'longing', 'temptation'], prompt: "Marcus pins you against his desk, completely ignoring the glowing monitors behind you. He demands an explicit commitment, voice tight with possessive need.", emotionalBeat: "Intentional partnership mixed with territorial devotion.", choices: [{ text: "Tell him you're fully his, sliding your hands under his jacket.", relationshipImpact: 14, chemistryImpact: 15, tone: { heat: 9, implication: 9, emotionalRisk: 8, publicRisk: 0 }, unlocksMemory: "marcus_intentional_partnership" }, { text: "Draft the agreement in bed, making him prove his negotiation skills.", relationshipImpact: 11, chemistryImpact: 14, tone: { heat: 9, implication: 10, emotionalRisk: 7, publicRisk: 0 }, futureCallback: "marcus_review_ritual" }, { text: "Avoid labels and keep it open-ended.", relationshipImpact: 2, chemistryImpact: 1, futureCallback: "marcus_ambiguity" }] }
  ],
  chloe: [
