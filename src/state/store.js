...
export const useGameStore = create((set, get) => {
  const store = {
    ...
    dispatch: (action) => set((state) => ({ gameState: gameReducer(state.gameState, action) })),
    ...
    resolveWorkEvent: (optionIndex) => get().dispatch({ type: 'RESOLVE_WORK_EVENT', payload: { optionIndex } }),
