...
export const useGameStore = create((set, get) => ({
  ...
  performAction: (actionName, timeIncrements, statChanges, energyCost, moneyChange, options) =>
    actions.performAction(get().gameState, get().dispatch, actionName, timeIncrements, statChanges, energyCost, moneyChange, options),
  ...
  jobHunt: (optionId) => get().dispatch({ type: 'JOB_HUNT', payload: { optionId } }),
